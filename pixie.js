...
function onAssetsLoaded(loader,res)
{
    ...
    foreground.position.y = foreground2.position.y = renderer.height - 120;
    //foreground.position.y = foreground2.position.y = 0;
    
    console.log("ground: " , foreground2);
    console.log("#1 ground h: " + foreground2._height);
    ...
    console.log("#2 ground h: " + foreground2._height);
